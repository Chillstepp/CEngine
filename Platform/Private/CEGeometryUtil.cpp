...
namespace CE{
	...
	void CEGeometryUtil::CreateCube(float leftPlane, float rightPlane, float bottomPlane, float topPlane, float nearPlane, float farPlane,
		std::vector<CEVertex> &vertices, std::vector<uint32_t> &indices, const bool bUseTextcoords,
